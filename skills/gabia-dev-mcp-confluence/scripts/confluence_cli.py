...
def build_parser() -> argparse.ArgumentParser:
    ...
    g.add_argument("--convert-to-markdown", action=argparse.BooleanOptionalAction, default=True)
    ...
    c.add_argument("--format", default="markdown", choices=["markdown", "wiki", "storage"])
    ...
    u.add_argument("--format", default="markdown", choices=["markdown", "wiki", "storage"])
